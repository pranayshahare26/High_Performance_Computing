...
int main()
{
	...
	//Allocate memory
	sumd = clCreateBuffer(context, CL_MEM_WRITE_ONLY, N * sizeof(double), NULL, &ret);
	...
	// Copy results back
	ret = clEnqueueReadBuffer(command_queue, sumd, CL_TRUE, 0, N*sizeof(double), sum, 0, NULL, NULL);
